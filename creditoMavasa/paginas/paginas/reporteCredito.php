...
<table cellspacing="0" style="width: 100%;">
        <tr>
            ...
            FECHA SOLICITUD: <?php echo date('d-m-Y', strtotime(@$fecha));?>
            </td>
    ...
    <table cellspacing="0" style="width: 100%;">
        <tr>
            <td style="width: 100%; color: #34495e;font-size:12px;text-align:center">
                <span style="color: #34495e;font-size:25px;font-weight:bold">Reporte de creditos por fecha</span>
            </td>
        </tr>
    </table>
 <br><br><br>
